...
mirror_mat=MirrorMaterial((0.9,0.9,0.9))
...
#ParseObj("cube.obj",obj,lambda x:(x[0]*25+100-60,x[1]*25-100+25,x[2]*25-35),mirror_mat)
obj.append(Sphere((100-60,-100+25,-35),25,mirror_mat))
