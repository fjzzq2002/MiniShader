...
{'images':BRDFMaterial((0,0,0),(0.7,0.7,0.7),0.8,(2.55*17,2.55*17,2.44*17)),
...
obj.append(RotateBSpline([-7,-5.3,11],glass_seq,BRDFMaterial((67/255.0,166/255.0,248/255.0),(0.03,0.03,0.03),0.5)))
