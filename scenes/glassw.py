...
cb_mat=Material((0,0,0),(0,0,0),0.3,("chessboard.jpg",(0.02,0.02)))
obj.append(Triangle((-200,-80,-100),(-200,-80,100),(200,-80,-100),water_glass_mat))
#obj.append(HeightField((work(1200,600)*2-80).tolist(),(200,-100),-400,200,water_glass_mat))
#obj.append(HeightField((work(1200,600)*2-80).tolist(),(-200,-100),400,200,glass_mat))
obj.append(Plane((0,-1,0),100,cb_mat))
